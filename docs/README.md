# PitWall Agent Documentation

## Current Status

V1 已形成可运行、可评测、可观测的全栈闭环。实现事实以当前代码、Alembic migrations、Compose、CI 和生成的评测报告为准。
...
4. [产品需求](cn/01_Product_Requirement_zh.md)：理解需求来源和功能边界。
5. [秋招面试指南](cn/03_Interview_Guide_zh.md)
6. [五分钟演示手册](cn/04_Demo_Runbook_zh.md)
7. [秋招交付说明](cn/05_Portfolio_Delivery_zh.md)
